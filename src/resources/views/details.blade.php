							...
							<div class="day" data-social="day">
								...
								<div class="card no-border bg-transparent full-width" data-social="item">
									...
									<!-- <div class="container-fluid p-t-30 p-b-30 "> -->
										<div class="row">
											<div class="col-lg-6">
												<p id="movie-overview" class="no-margin fs-16"></p>
											</div>
											<div class="col-lg-6">
												<h5 class="no-margin p-b-5">Grade - <span id="grade_response"></span></h5>
												<h5 class="no-margin p-b-5">Release - <span id="year_response"></span></h5>
												<h5 class="no-margin p-b-5">Budget - <span id="budget_response"></span></h5>
												<h5 class="no-margin p-b-5">Revenue - <span id="revenue_response"></span></h5>
												<h5 class="no-margin p-b-5">Language - <span id="lang_response"></span></h5>
												<h5 class="no-margin p-b-5">Runtime - <span id="runtime_response"></span></h5>
											</div>
										</div>
									<!-- </div> -->
									<!-- END CONTAINER FLUID -->
